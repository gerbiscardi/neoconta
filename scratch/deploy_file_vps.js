...
const localFilePath = path.join(__dirname, '..', 'app', 'dashboard', 'comentor', 'page.js');
const remoteFilePath = '/var/www/neoconta/app/dashboard/comentor/page.js';
