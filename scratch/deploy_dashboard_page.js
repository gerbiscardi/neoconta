...
const localFilePath = path.join(__dirname, '..', 'app', 'dashboard', 'page.js');
const remoteFilePath = '/var/www/neoconta/app/dashboard/page.js';
...
conn.on('ready', async () => {
  console.log('SSH connection established to deploy dashboard page.');
  try {
    // 1. Upload page.js
    ...
    console.log('Dashboard deployment completed successfully!');
  } catch (err) {
