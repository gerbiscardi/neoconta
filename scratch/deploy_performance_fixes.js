...
const filesToUpload = [
  {
    local: path.join(__dirname, '..', 'app', 'dashboard', 'facturacion', 'page.js'),
    remote: '/var/www/neoconta/app/dashboard/facturacion/page.js'
  },
  {
...
conn.on('ready', async () => {
  console.log('SSH connection established for Performance fixes deployment.');
  try {
    // SFTP upload both files
    ...
    // Remove old build folder to clean cache
    ...
    console.log('Performance fixes deployment completed successfully!');
  } catch (err) {
