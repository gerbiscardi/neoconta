...
const localFilePath = path.join(__dirname, '..', 'app', 'globals.css');
const remoteFilePath = '/var/www/neoconta/app/globals.css';
...
conn.on('ready', async () => {
  console.log('SSH connection established to deploy CSS.');
  try {
    // 1. Upload the globals.css file
    ...
    console.log('CSS deployment completed successfully!');
  } catch (err) {
